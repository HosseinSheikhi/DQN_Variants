...
class DoubleDQNAgent:
    ...
    def save_model(self, env_name, episode_num):
        self.model.save("saved_model/double_dqn_" + str(env_name) + '_' + str(episode_num))

    def load_model(self, env_name, episode_num):
        tf.print("loading Model ...")
        self.model = tf.keras.models.load_model("saved_model/double_dqn_" + str(env_name) + '_' + str(episode_num))
